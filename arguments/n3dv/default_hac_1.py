...
OptimizationParams = dict(
    ...
    static_densify_until_iter=8000,
    # position_lr_init=0.0,
    # position_lr_final=0.0,
    mlp_deform_lr_init=0.005,  # anchor # 0.005
    mlp_deform_lr_final=0.00005,         # 0.0005
    ...
    static_densification_interval=500,  # 300  500 for coffee
    densify_grad_threshold_dynamic=0.00015,
