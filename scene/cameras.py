...
class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, image, gt_alpha_mask,
                 ...
                 mask = None, depth=None, width=None, height=None, cxr=None, cyr=None, **kwargs
                 ):
        ...
        if 'lf_map' in kwargs.keys():
            self.lf_map = kwargs['lf_map']
            self.seg_map = kwargs['seg_map']
        else:
            self.lf_map = None
            self.seg_map = None
    ...
    def cuda(self):
        ...
        if self.lf_map is not None:
            self.lf_map = self.lf_map.cuda()
            self.seg_map = self.seg_map.cuda()
...
class Camerass(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, image, fisheye_mapper,
                 image_name, uid,
                 trans=np.array([0.0, 0.0, 0.0]), scale=1.0, data_device = "cuda", time = 0,
                 mask = None, depth=None, width=None, height=None, cxr=None, cyr=None
                 ):
        ...
        self.image_name = image_name
        self.time = time
        self.fisheye_mapper = fisheye_mapper
        ...
        if self.fisheye_mapper is not None:
